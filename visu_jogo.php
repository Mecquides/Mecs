...
<title><?php echo $Fetch['nome_J']; ?></title>
...
.parallax 
{
  ...
  background-image: url("img/jogos/<?php echo $Fetch['img_2']; ?>");
  min-height: 500px; 
...
.parallax2 
{
  background-image: url("img/jogos/<?php echo $Fetch['img_3']; ?>");
  min-height: 500px; 
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
...
<div class="boxtext">
    ...
    <h2 class="ti"><?php echo $Fetch['descri']; ?><h2>
</div>
...
<div class="boxtext">
    ...
    <h2 class="ti"><?php echo $Fetch['plataforma']; ?><h2>
  <a href="<?php echo $Fetch['link_J']; ?>"><button class="ti2" style="vertical-align:middle">Baixar</button></a>
</div>
